...
export default function Conversion(props) {
    ...
    useEffect(() => {
        fetch(`https://planme-3366bb9023b7.herokuapp.com/api/users/f6084d8f-3a96-4288-b18f-fc174ce13b01/tasks/${taskId}/subtasks`)
    ...
    const handleShowSubtasks = () => {
        ...
        fetch(`https://planme-3366bb9023b7.herokuapp.com/api/tts/`, {
            method: 'POST',
            headers: {
...
// Delete function
    const handleDelete = (subtaskId) => {
        ...
        fetch(`https://planme-3366bb9023b7.herokuapp.com/api/users/f6084d8f-3a96-4288-b18f-fc174ce13b01/tasks/${taskId}/subtasks/${subtaskId}/`, {
            method: 'DELETE'
        })
            .then(response => {
                if (response.ok) {
