                ...
                return (
                    <Stack key={key} direction='column' maxW='max-content'>
                        <Stack
                            ...
                            align='center'
                            cursor='default'>
                            <IconBox bg='brand.500' h='30px' w='30px'
                                     me='10px'>
                                {link.icon}
                            </IconBox>
                            <Text fontWeight='bold' fontSize='md' me='auto'
                                  color={textColor}>
                                {link.name}
                            </Text>
                            <Icon
            ...
            <Stack
                ...
                <Menu isOpen={isOpenAuth}>
                    <MenuList
                        ...
                        left='-10px'>
                        <Flex>
                            <SimpleGrid columns='3' gap='10px' minW='500px'
                                        me='20px'>
            ...
            <Stack
                ...
                <Menu isOpen={isOpenMain}>
                    <MenuList
                        ...
                        top='30px'
                        left='-10px'>
                        <Flex flexWrap='wrap' align='start' w='500px'
                              gap='16px'>
